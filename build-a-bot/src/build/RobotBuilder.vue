...
import createdHookMixing from './created-hook-mixin';
...
export default{
  ...
  methods: {
    ...
    selectNextHead() {
      const nextIndex = getNextValidIndex(this.selectedHeadIndex, this.availableParts.heads.length);
      this.selectHead(nextIndex);
    },
    selectPreviousHead() {
